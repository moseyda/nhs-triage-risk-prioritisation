...
ax.set_ylabel('Empirical Score (0.0 to 1.0)', fontsize=12)
ax.set_title('Fig 1: Impact of Hyperparameter Scaling (Batch-Size Paradox) on Transformer Triage', fontsize=14, fontweight='bold', pad=20)
ax.set_xticks(x)
